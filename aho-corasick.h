...
aho_corasick_int_t ahocorasick_KeywordTree_search_helper(aho_corasick_state_t *,unsigned char *,int, int, size_t *, size_t *, aho_corasick_state_t **);
aho_corasick_int_t ahocorasick_KeywordTree_search_long_helper(aho_corasick_state_t *,unsigned char *,int, int, size_t *, size_t *, aho_corasick_state_t **);

/* type of any function that helps with search. */
typedef aho_corasick_int_t (*ahocorasick_KeywordTree_search_helper_t)
  (aho_corasick_state_t*, unsigned char *, int, int, 
